...
// ============================================================================
// CruxEngine Marketplace — Asset store for sharing/purchasing content
// ============================================================================
...
public:
    ...
    bool installAsset(u32 catalogIndex) {
        ...
        CRUX_LOG_INFO("[Marketplace] installing '%s' v%s by %s",
    ...
    void loadDemoCatalog() {
        addAsset("Stylized Trees Pack", "Low-poly stylized trees", "CruxTeam", "Mesh",
