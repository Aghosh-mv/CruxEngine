...
// Minimal OpenGL function loader for the CruxEngine renderer.
...
#define CRUX_DECLARE_FUNC(NAME, RET, ARGS) extern RET (*NAME) ARGS;
CRUX_GL_FUNCS(CRUX_DECLARE_FUNC)
#undef CRUX_DECLARE_FUNC
