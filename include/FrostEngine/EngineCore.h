...
// ============================================================================
// FrostEngine Core — Main engine facade that wires all systems together
// ============================================================================
// This is the entry point for anyone building a game with FrostEngine.
...
struct EngineConfig {
    ...
    const char* windowTitle = "FrostEngine";
