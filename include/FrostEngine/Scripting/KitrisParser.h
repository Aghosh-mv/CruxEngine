...
// ============================================================================
// FrostEngine Kitris Parser — AST and parsing
// ============================================================================
...
private:
    ...
    const Token& peek(i32 offset = 1) const { return tokens_[pos_ + offset < (i32)tokens_.size() ? pos_ + offset : (i32)tokens_.size() - 1]; }
