...
// ============================================================================
// FrostEngine Code Editor — Built-in script editing
// ============================================================================
// Provides:
...
public:
    ...
    void moveUp() { if (cursorLine_ > 0) cursorLine_--; if (cursorCol_ > (u32)lines_[cursorLine_].length()) cursorCol_ = (u32)lines_[cursorLine_].length(); }
    void moveDown() { if (cursorLine_ + 1 < lines_.size()) cursorLine_++; if (cursorCol_ > (u32)lines_[cursorLine_].length()) cursorCol_ = (u32)lines_[cursorLine_].length(); }
    ...
    void tokenizeLine(u32 lineIdx, Vector<SyntaxToken>& tokens) const {
        ...
        while (i < line.length()) {
            ...
            if ((c >= 'a' && c <= 'z') || (c >= 'A' && c <= 'Z') || c == '_') {
                ...
                SyntaxToken::TokenType type = SyntaxToken::IDENTIFIER;
